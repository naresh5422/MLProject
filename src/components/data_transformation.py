...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            categorical_columns = ['gender','race_ethnicity', 'parental_level_of_education','lunch','test_praparation_course']
            ...
            preprocessing = ColumnTransformer([('Numerical_pipeline', num_pipeline, numerical_features),
